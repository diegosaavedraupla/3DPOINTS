//Visualizador de datos en 3D 
//Autor Diego Saavedra Lizana 
//Proyecto de titulo "modelado de hipocentros sismicos en 3D"
...
dataset = data;
    console.log("datos: " + dataset[0])
    init();
    animate();
});
//Fin cargar datos desde .csv
...
function init() {
	...
	//Cámara en perspectiva (fov: Número , aspecto: Número , cerca: Número , lejos: Número )
	//fov - Cámara vertical campo de visión vertical. 
	//Aspecto - Relación de aspecto de cámara frustum. 
	//cerca - cámara frustum cerca de avión. 
	//lejos - cámara frustum plano lejano. 
    camera = new THREE.PerspectiveCamera( 75, window.innerWidth / window.innerHeight, 1, 1000 );
    //Crea un objeto en la cescena
