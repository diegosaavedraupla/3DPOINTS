...
! function (n, t) {
	...
	function e(n, e) {
		var r = new t;
		if (n instanceof t) n.each(function (n, t) {
			r.set(t, n)
		});
			...
			if (null == e)
				...
				for (; ++u < o;) r.set(e(i = n[u], u, n), i)
		} else if (n)
			for (var s in n) r.set(s, n[s]);
		return r
	}
	...
	function c(n, t) {
		var e = new s;
		if (n instanceof s) n.each(function (n) {
			e.add(n)
		});
		else if (n) {
			var r = -1,
	...
	s.prototype = c.prototype = {
		...
		function a(r, i, u, o) {
			...
			for (var s, c, h, l = -1, v = r.length, p = f[i++], y = e(), d = u(); ++l < v;)(h = y.get(s = p(c = r[l]) + "")) ? h.push(c) : y.set(s, [c]);
			return y.each(function (n, t) {
				o(d, t, a(n, i, u, o))
			}), d
		}
		return s = {
			...
			entries: function (n) {
				return function n(e, r) {
					...
					var i, u = c[r - 1];
					return null != t && r >= f.length ? i = e.entries() : (i = [], e.each(function (t, e) {
						i.push({
							key: e,
							values: n(t, r)
						})
					})), null != u ? i.sort(function (n, t) {
	...
	}, n.set = c, n.map = e, n.keys = function (n) {
		var t = [];
